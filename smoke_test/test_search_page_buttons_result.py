...
def search_filter(playwright: Playwright, test_name: str) -> None:
    ...
    page.click("//span[@class='styles_cross__2L9Ti']")  # erase button

    page.fill("//input[@class='styles_text-search__2FsJ9']", "Платье")

    page.locator(".styles_search-icon__3-2Kq").click()
...
def test_search_product_and_filter():
    with sync_playwright() as playwright:
        test_name = "test_search_page_buttons_result"
